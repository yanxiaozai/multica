...
CREATE TABLE IF NOT EXISTS issue_bridge_item (
...
CREATE INDEX IF NOT EXISTS idx_issue_bridge_item_issue ON issue_bridge_item(issue_id);
CREATE INDEX IF NOT EXISTS idx_issue_bridge_item_workspace ON issue_bridge_item(workspace_id);
