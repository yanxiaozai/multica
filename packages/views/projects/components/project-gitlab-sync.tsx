                      ...
                      items={[
                        {
                          ...
                          label: t(($) => $.gitlab_sync.sync_mode_assigned_to_me),
                        },
                        {
                          value: "auto_accept",
                          label: t(($) => $.gitlab_sync.sync_mode_auto_accept),
                        },
                      ]}
                      onValueChange={(v) => {
              ...
              {autoAssign && (
                <div className="grid gap-2 sm:grid-cols-2">
                  <div>
                    ...
                    <Select
                      ...
                      items={[
                        {
                          value: "agent",
                          label: t(($) => $.gitlab_sync.assignee_type_agent),
                        },
                        {
                          value: "squad",
                          label: t(($) => $.gitlab_sync.assignee_type_squad),
                        },
                      ]}
                      onValueChange={(v) => {
                  ...
                  <div>
                    ...
                    <Select
                      value={agentId}
                      items={visibleAssignees.map((assignee) => ({
                        value: assignee.id,
                        label: assignee.name,
                      }))}
            ...
            !noIntegration && !autoDetect && (
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <Select
                    value={integrationId}
                    items={integrations.map((itg) => ({
                      value: itg.id,
                      label: itg.name || itg.base_url,
                    }))}
